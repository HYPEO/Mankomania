...
public class RouletteFieldActor extends FieldActor{
     ...
     */
    public RouletteFieldActor(float x, float y, float width, float height, int price, Texture texture, Texture detailTexture, DetailActor detailActor, StageFactory stageFactory, StageManager stageManager) {
